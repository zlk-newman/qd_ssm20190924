...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/Hplus-v.4.1.0/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/static/Hplus-v.4.1.0/css/font-awesome.min.css?v=4.4.0"
          rel="stylesheet">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle"
                                   src="${pageContext.request.contextPath}/static/Hplus-v.4.1.0/img/profile_small.jpg"/></span>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" target="iframe0"
                               href="${pageContext.request.contextPath}/forward?pg=userInfoManager/userInfoAdd"
                               data-index="0">用户信息新增</a>
                        </li>
                        <li>
                            <a class="J_menuItem" target="iframe0"
                               href="${pageContext.request.contextPath}/forward?pg=userInfoManager/userInfoAjaxQuery">用户信息查询</a>
                        </li>
                        <li>
                            <a class="J_menuItem" target="iframe0"
                               href="${pageContext.request.contextPath}/forward?pg=userInfoManager/userInfoAjaxQueryWithPagination">用户信息查询[假分页]</a>
                        </li>
                        <li>
                            <a class="J_menuItem" target="iframe0"
                               href="${pageContext.request.contextPath}/forward?pg=ajaxdemo/ajaxdemo" data-index="0">ajax原生</a>
                        </li>
                        <li>
                            <a class="J_menuItem" target="iframe0"
                               href="${pageContext.request.contextPath}/forward?pg=ajaxdemo/ajaxdemojquery"
                               data-index="0">ajax-jquery</a>
                        </li>
